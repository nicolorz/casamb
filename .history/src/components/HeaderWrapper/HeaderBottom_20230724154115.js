...
export const HeaderBottom = () => {
    ...
    function handleClick(tag, buttonState) {
        console.log('stato active', buttonState);
        if(buttonState) {
            setClickedButtons([...clickedButtons, tag]);
        } else {
            setClickedButtons(clickedButtons.filter((el) => el !== tag));
        };
    }

    console.log('pulsanti cliccati', clickedButtons);
